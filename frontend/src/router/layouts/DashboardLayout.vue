...
// // Map backend menu items to frontend format
// const visibleMenuItems = computed(() => {
//   if (menuStore.isLoading) {
//     console.log('Menu items are still loading');
//     return [];
//   }

//   const mainMenu = menuStore.getMenuByLocation('sidebar');
//   console.log('Main menu:', mainMenu);
  
//   if (!mainMenu || !mainMenu.items) {
//     console.log('No main menu or items found');
//     return [];
//   }

//   return mainMenu.items
//     .filter(item => !item.roles || userHasAccess(item.roles))
//     .map(item => ({
//       name: item.label,
//       path: item.url,
